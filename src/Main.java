...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Вы используете калькулятор, который сразу вычисляет арифметическое выражение для двух значений." +
                           ...
                           "\n P.S.S.S Также вы можете воспользоваться возможностью просмотреть последние 10 операций с результатом вычисления" +
                           "\n         Для этого введите в консоль слово 'memory'." +
                           "\n P.S.S.S.S Для данной версии калькулятора предусмотрено возведение ТОЛЬКО В НАТУРАЛЬНУЮ степень." +
                           "\n           и ограничено размерами 999 999 999. Вы же осознаёте насколько это большое число на выходе?" +
                           "\n           И что ждать ответа полчаса... Учитывайте эту информацию при вводе выражения.");

        new Calculator().startWorkingCalculator();
    }
}
